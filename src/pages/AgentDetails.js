...
const AgentDetails = () => {
    ...
    const handleInputChange1 = (event) => {const inputValue = event.target.value;
        if (/^\d*$/.test(inputValue)) {
            ...
            const handleInputChange21 = (event) => {const inputValue = event.target.value;
                if (/^\d*$/.test(inputValue)) {
                    setValue21(inputValue);  }};
                ...
                <div className='agent_details_page'>
                    ...
                    <div className='adp_input_list'>
                        ...
                        <div className="apro_input add adp">
                            ...
                            />
                            <div className='errrorr'>{error && <p>{error}</p>}</div>
                        </div>
                        ...
                        <div className="filter_search_desc_second adp">
                            <div className="label_box adp">
                                ...
                                <select className="lable_box_items selectable adp">
                    ...
                    <div className='adp_input_list'>
                        ...
                        <div className="filter_search_desc_second">
                            <div className="label_box adp2">
                                ...
                                <select className="lable_box_items adp">
